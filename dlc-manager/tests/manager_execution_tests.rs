...
fn numerical_common(
    ...
    let params = numerical_params(nb_oracles, threshold, difference_params);
    manager_execution_test(params, TestPath::Close);
}
...
fn numerical_common_diff_nb_digits(
    ...
    let params =
        numerical_params_diff_nb_digits(nb_oracles, threshold, difference_params, use_max_value);
    manager_execution_test(params, TestPath::Close);
}
